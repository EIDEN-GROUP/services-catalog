  ...
  return (
    <section id="testimonials" className="relative bg-forest text-cream py-12 md:py-16 overflow-hidden">
      <div className="relative mx-auto max-w-[1400px] px-5 md:px-10">
        {/* Title */}
        <div className="pb-4 border-b-2 border-forest">
        ...
        <motion.div
          ...
          className="pt-8 grid grid-cols-1 md:grid-cols-12 gap-6 items-start md:items-center border-t-2 border-forest"
        >
          ...
          <div className="md:col-span-5 md:text-right">
            <button
              ...
              className="group inline-flex w-full sm:w-auto items-center justify-center gap-3 rounded-full border border-canvas py-3.5 md:px-7 md:py-4 font-head text-sm font-medium text-canvas hover:bg-mondrian-red hover:border-mondrian-red transition focus-ring"
            >
